return {
    ...
    DEFAULT_BUCKET_REF_TIMEOUT = 60 * 5,
    DEFAULT_BUCKET_CHUNK_TIMEOUT = 60 * 5,
    DEFAULT_BUCKET_SYNC_TIMEOUT = 60,

    REPLICA_LAG_LIMIT = 30,
    LOG_RATELIMIT_INTERVAL = 30,
    ...
    MASTER_ENABLE_WAIT_INTERVAL = 0.1,
