...
local cfg = {
    ...
    sharding = {
        { -- replicaset #1
            { uri = 'storage:storage@127.0.0.1:3301', name = 'storage_1_a', master = true },
            { uri = 'storage:storage@127.0.0.1:3302', name = 'storage_1_b' },
        },

        { -- replicaset #2
            { uri = 'storage:storage@127.0.0.1:3303', name = 'storage_2_a', master = true },
            { uri = 'storage:storage@127.0.0.1:3304', name = 'storage_2_b' },
        },
...
On storages call `vshard.storage.cfg(cfg, <INSTANCE_NAME>)`:
